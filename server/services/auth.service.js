...
module.exports = {
	userValidationRules,
  	...
  	async registerUser(req, res, next) {
    	...
    	const member = new User({ first_name: '', last_name: '', email: email, password: password, avatar: 'https://api.todoapp.jakubwilk.pl/uploads/avatardefault.png', description: '', blocked: false });
